...
Main Object: Car Interior
        ...
        Sub Object: Instrument Cluster
                ...
                Name 3 actions that the [Sub Object] can do:
                        1) indicates the speed at which the vehicle is traveling
                        2) indicates the revolutions per minute of the engine
                        3) indicates the distance traveled by the vehicle
        
        Sub Object: Environment Controls
                Name 3 nouns you'll find on the [Sub Object]
                        1) A/C button
                        2) recirculate button
                        3) fan speed button
                Name 3 actions that the [Sub Object] can do:
                        1) activate air recirculation
                        2) activate air conditioning
                        3) regulate fan speed
        ...
        Sub Object: Infotainment System
                Name 3 nouns you'll find on the [Sub Object]
                        ...
                        3) GPS navigation
                Name 3 actions that the [Sub Object] can do:
                        1) pair with other devices
                        2) display relevant information
                        3) display instructions for navigating to a location
